...
if (-not (Test-SkipProject 'SecureDesktopLauncher')) {
    ...
    Build-MsvcProject -Project 'SecureDesktopLauncher' -Source 'SecureDesktopLauncherService.cpp' -OutputName 'SecureDesktopLauncher.exe' -CompileArgs @('/EHsc', '/W4') -LinkArgs @('advapi32.lib', 'wtsapi32.lib', 'userenv.lib')
    ...
    New-Package -Name 'SecureDesktopLauncher' -Project 'SecureDesktopLauncher' -Paths @('build\SecureDesktopLauncher.exe', 'build\SecureDesktopPasswordLauncher.exe')
}
