...
cl /nologo /utf-8 /std:c++17 /EHsc /W4 /DUNICODE /D_UNICODE tools\RssLiveTileSourceCheck.cpp /Fe:build\obj\RssLiveTileSourceCheck.exe /Fo:build\obj\RssLiveTileSourceCheck.obj /link gdiplus.lib winhttp.lib gdi32.lib user32.lib shell32.lib shlwapi.lib ole32.lib windowsapp.lib runtimeobject.lib /SUBSYSTEM:CONSOLE
if errorlevel 1 (
...
build\obj\RssLiveTileSourceCheck.exe
set "STATUS=%ERRORLEVEL%"
popd
exit /b %STATUS%
