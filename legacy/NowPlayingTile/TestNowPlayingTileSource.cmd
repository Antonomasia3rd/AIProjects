...
cl /nologo /utf-8 /std:c++17 /EHsc /W4 tools\NowPlayingTileSourceCheck.cpp /Fe:build\obj\NowPlayingTileSourceCheck.exe /Fo:build\obj\NowPlayingTileSourceCheck.obj
if errorlevel 1 (
...
build\obj\NowPlayingTileSourceCheck.exe
set "STATUS=%ERRORLEVEL%"
popd
exit /b %STATUS%
