...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        checks.push_back({"Live wallpaper capture rejects blank PrintWindow frames", "src\\ga_wallpaper.inc", wallpaper, R"rx(PixelsLookBlankOrBlack)rx", "live wallpaper capture must reject black/blank snapshots instead of generating black tiles", false});
