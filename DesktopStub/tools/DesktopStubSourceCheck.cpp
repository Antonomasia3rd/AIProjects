...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        checks.push_back({"Shared config dependency exposes an explicit config store", "..\\dependencies\\config_ini.inc", sharedConfig, R"rx(class IniConfigStore.*ReadRaw.*WriteRaw.*EnsureDefaults.*ReadFreshText.*WriteFreshText)rx", "baseline projects must have a reusable configuration store contract", false});
