...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        checks.push_back({"Versioned release tags follow built executable versions", "..\\.github\\tools\\RepoTools.cs", repoTools, R"rx(EmbeddedBinaryReleaseTag.*DesktopStub.*DiscordRPC.*VerifyBinaryVersion.*embeddedBinaryTag.*release tag does not match the executable FileVersion)rx", "automatic releases for migrated versioned apps must use the vN embedded in the built executable", false});
