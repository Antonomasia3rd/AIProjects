...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        checks.push_back({"Shared application baseline exposes explicit subsystem contracts", "..\\dependencies\\baseline_app.h", baselineApp, R"rx(struct InstanceIdentity.*BuildInstanceIdentity.*SignalInstanceWindow.*RegisterTaskbarCreatedMessage.*FormatTextTemplate.*class TraySectionLayout)rx", "the baseline must expose reusable single-instance, taskbar, help-template, and tray-layout APIs instead of product-local copies", false});
