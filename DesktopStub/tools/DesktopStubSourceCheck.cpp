...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        checks.push_back({"Windows 10 preset XML uses the native Windows 8.1 catalog", "Live Tile XML sources", liveTileSources, R"rx(LiveTileUsesWindows81PresetXml.*visual version=.*4.*branding=.*logo.*TileSquare150x150Block.*TileSquareBlock.*TileSquare150x150Text02.*TileSquareText02.*TileWide310x150BlockAndText02.*TileWideBlockAndText02.*TileWide310x150ImageAndText02.*TileWideImageAndText02.*TileSquare310x310BlockAndText02.*TileSquare310x310ImageAndTextOverlay02)rx", "Windows81Preset must emit native version-4 catalog bindings and Windows 8 fallback names instead of simulated adaptive geometry", false});
