...
int main()
{
    try
    {
        ...
        const std::string app = ReadAll("..\\dependencies\\DiscordRPC\\drpc_app.inc");
        const std::string ipc = ReadAll("..\\dependencies\\DiscordRPC\\drpc_ipc.inc");
        const std::string gateway = ReadAll("..\\dependencies\\DiscordRPC\\drpc_gateway.inc");
        const std::string presence = ReadAll("..\\dependencies\\DiscordRPC\\drpc_presence.inc");
        const std::string tray = ReadAll("..\\dependencies\\DiscordRPC\\drpc_tray.inc");
        const std::string types = ReadAll("..\\dependencies\\DiscordRPC\\drpc_types.inc");
        ...
        RequireContains(
            ...
            "..\\dependencies\\DiscordRPC\\drpc_types.inc + ..\\dependencies\\DiscordRPC\\drpc_command_line.inc",
            types + "\n" + commandLine,
        ...
        RequireContains(
            ...
            "..\\dependencies\\DiscordRPC\\drpc_command_line.inc + ..\\dependencies\\DiscordRPC\\drpc_types.inc",
            commandLine + "\n" + types,
            "tokenToProtect");
        RequireNotContains(
        ...
        RequireContains(
            ...
            "DiscordRPC.cpp + ..\\dependencies\\DiscordRPC\\drpc_core.inc",
            discordMain + "\n" + core,
        ...
        RequireContains(
            ...
            "..\\dependencies\\DiscordRPC\\drpc_core.inc + ..\\dependencies\\DiscordRPC\\drpc_config_defaults.inc",
            core + "\n" + defaults,
        ...
        RequireContains(
            ...
            "..\\dependencies\\DiscordRPC\\drpc_gateway.inc",
            gateway,
            "JsonTryExtractInt");
        RequireNotContains(
        ...
        RequireContains(
            ...
            "..\\dependencies\\DiscordRPC\\drpc_ipc.inc",
            ipc,
        ...
        RequireContains(
            ...
            "..\\dependencies\\DiscordRPC\\drpc_presence.inc + ..\\dependencies\\DiscordRPC\\drpc_ipc.inc",
            presence + "\n" + ipc,
        ...
        RequireContains(
            ...
            "..\\dependencies\\DiscordRPC\\drpc_presence.inc",
            presence,
