...
cl /nologo /utf-8 /std:c++17 /EHsc /W4 /DUNICODE /D_UNICODE tools\PackagedStartupTests.cpp /Fe:build\PackagedStartupTests.exe /Fo:build\PackagedStartupTests.obj /link user32.lib shell32.lib ole32.lib uuid.lib windowsapp.lib runtimeobject.lib /SUBSYSTEM:CONSOLE
set "STATUS=%ERRORLEVEL%"
if not "%STATUS%"=="0" (
    popd
    exit /b %STATUS%
)
build\PackagedStartupTests.exe
set "STATUS=%ERRORLEVEL%"
popd
exit /b %STATUS%