...
cl /nologo /utf-8 /std:c++17 /EHsc /W4 /WX tools\ContentSourceHostTests.cpp /Fe:build\ContentSourceHostTests.exe /Fo:build\ContentSourceHostTests.obj
if errorlevel 1 goto Failed
build\ContentSourceHostTests.exe
